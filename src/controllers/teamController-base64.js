...
module.exports.team = {
  list: async function (req, res) {
    ...
    const teams = await res.getModelList(Team);
    ...
    const formattedTeams = teams.map((team) => {
      ...
      return {
        ...
        image: bufferToBase64(team?.image), // sadece base64
        createdAt: team.createdAt,
        updatedAt: team.updatedAt,
      };
    });
  ...
  create: async (req, res) => {
    /*
            ...
            #swagger.description = `
                ...
                - Email type Rules- --@--.--</br>
                - Required fields: - fullName, description, email, and fileUploading(imageFile)</br>  
    ...
    // newTeam.image.url = process.env.WEBSITE + "/api/files/team/" + newTeam?._id;

    // await newTeam.save();
    // delete newTeam.image.buffer;
  ...
  update: async (req, res) => {
    ...
    res.status(202).json({
      ...
      message: "Team member is updated!",
      data,
      new: await Team.findOne({ _id: req.params.id },{image:0}),
    });
  },
